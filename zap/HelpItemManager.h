...
#define HELP_ITEM_TABLE                                                                                                                                                                                                           \
   ...
   HELP_TABLE_ITEM(LoadoutChangedZoneItem,       LoadoutZoneTypeNumber,         false, false, TorNeut,    Now,       ARRAYDEF({ "You've selected a new ship configuration.",                                                      \
                                                                                                                                "Find a Loadout Zone ([[LOADOUT_ICON]]) to activate the changes.", NULL }))                       \
   ...
   HELP_TABLE_ITEM(SafeZoneItemTeam,              SafeZoneTypeNumber,           true,  false, TorNeut,    Low,       ARRAYDEF({ "You are safe here; enemies cannot harm you while you are inside.", NULL }))                      \
   HELP_TABLE_ITEM(SafeZoneItemEnemy,             SafeZoneTypeNumber,           true,  false, Enemy,      Low,       ARRAYDEF({ "Your enemies are safe here; They can hurt you, but you can't hurt them.", NULL }))               \
