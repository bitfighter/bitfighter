...
// Constructor
MoveObject::MoveObject(const Point &pos, F32 radius, F32 mass) : Parent(pos, radius)    
{
...
// Constructor
MountableItem::MountableItem(Point p, bool collideable, float radius, float mass) : Parent(p, collideable, radius, mass)
{
   mIsMounted = false;
