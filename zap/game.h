...
#define CS_PROTOCOL_VERSION 17     // Change this when releasing an incompatible cs protocol (must be int)
#define BUILD_VERSION 405          // Version of the game according to SVN, will be unique every release (must be int)
