...
extern void renderXtankVehicleOverlay(const Point &pos, F32 bodyAngle, F32 alpha,
                                       XtankBody bodyIdx, S32 heatSinkCount,
...
extern void renderFuelZone(const Color *color, const Vector<Point> *outline, const Vector<Point> *fill,
                           const Point &centroid, F32 angleRadians = 0.0f);
extern void renderRepairZone(const Color *color, const Vector<Point> *outline, const Vector<Point> *fill,
                             const Point &centroid, F32 angleRadians = 0.0f);
...
extern void renderProjectileXtankBullet(const Point &pos, U32 style);
extern void renderProjectileXtankLaser(const Point &pos, const Point &velocity);
...
#define renderProjectileXtankBullet
#define renderProjectileXtankLaser
