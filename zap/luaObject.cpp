...
bool LuaObject::loadHelperFunctions(lua_State *L, const string &scriptDir, const string &helperName, const string &caller)
{
   string fname = joindir(scriptDir, helperName);
