...
////////////////////////////////////////
////////////////////////////////////////
// Cursors embedded below.  Note that image data comes from Gimp -- create the image, save as "c" type, and copy the struct below.  The 
// only modification is to add the two hotspot bytes.  Images can be full color, with transparency.
