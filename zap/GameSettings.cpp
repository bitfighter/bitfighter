...
{ "cachedir",              ONE_REQUIRED,   CACHE_DIR,             3, "<path>",                "Folder where cache files are stored",        "You must specify the folder where cache files are to be stored with the -cachedir option" },
