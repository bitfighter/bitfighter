...
#define SETTINGS_TABLE   \
   ...
   SETTINGS_ITEM(U32,                VoteRetryLength,          "Host-Voting",    "VoteRetryLength",          30,                              "When a vote fails, the vote caller is unable to vote until after this number of seconds.")                                     \
