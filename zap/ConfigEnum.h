...
#define SETTINGS_TABLE   \
   ...
   SETTINGS_ITEM(U32,                MaxFpsServer,             "Host",           "MaxFPS",                   100,                             "Maximum FPS the dedicated server will run at.  Higher values use more CPU (and power), lower may increase lag.\n"              \
                                                                                                                                              "Specify 0 for no limit. (default = 100)")                                                                                      \
                                                                                                                                                                                                                                                                              \
