...
#define SETTINGS_TABLE   \
   ...
   SETTINGS_ITEM(YesNo,              QueryServerSortAscending, "Settings",       "QueryServerSortColumn",    Yes,                             NULL,     NULL,     "Yes for ascending sort, No for descending.  This value managed by game.")                                                      \
