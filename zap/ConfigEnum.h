...
#define SETTINGS_TABLE   \
   ...
   SETTINGS_ITEM(S32,                QueryServerSortColumn,    "Settings",       "QueryServerSortColumn",    0,                               NULL,     NULL,     "Index of column to sort by when in the Join Servers menu. (0 is first col.)  This value managed by game.")                     \
   SETTINGS_ITEM(YesNo,              QueryServerSortAscending, "Settings",       "QueryServerSortAscending", Yes,                             NULL,     NULL,     "Yes for ascending sort, No for descending.  This value managed by game.")                                                      \
   ...
   SETTINGS_ITEM(YesNo,              Vsync,                    "Settings",       "Vsync",                    Yes,                             NULL,     NULL,     "Turns on vertical sync. Yes/No")                                                                                               \
                                                                                                                                                                                                                                                                                                  \
   ...
   SETTINGS_ITEM(YesNo,              ShowConnectionsToMaster, "EditorSettings", "ShowConnectionsToMaster",   Yes,                             NULL,     NULL,     "Should the editor notify user of all connections to the master server?")                                                       \
   SETTINGS_ITEM(U32,                GridSize,                "EditorSettings", "GridSize",                  255,                             NULL,     NULL,     "Grid size used in the editor, mostly for snapping purposes")                                                                   \
                                                                                                                                                                                                                                                                                                 \
   ...
   SETTINGS_ITEM(string,             WelcomeMessage,           "Host",           "WelcomeMessage",           "",                              NULL,     NULL,     "A message to be displayed to players when they connect to this server.")                                                       \
   ...
   SETTINGS_ITEM(YesNo,              GameRecordingDownload,    "Host",           "GameRecordingDownload",    No,                              NULL,     NULL,     "If Yes, other players can download")                                                                                           \
