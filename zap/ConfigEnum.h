...
#define SETTINGS_TABLE   \
   ...
   SETTINGS_ITEM(string,             ServerAddress,            "Host",           "ServerAddress",            MASTER_SERVER_LIST_ADDRESS,      "Socket address and port to bind to, e.g. IP:Any:9876 or IP:54.35.110.99:8000 or IP:bitfighter.org:8888 (leave blank to let the system decide; this is almost always what you want)")                                            \
   ...
   SETTINGS_ITEM(YesNo,              AllowDataConnections,     "Host",           "AllowDataConnections",     No,                              "When data connections are allowed, anyone with the admin password can upload or download levels, bots, or levelGen scripts.  This feature is probably insecure, and should be DISABLED unless you require the functionality.")  \
   ...
   SETTINGS_ITEM(YesNo,              AllowMapUpload,           "Host",           "AllowMapUpload",           No,                              ">>> Add AllowMapUpload Help ")                                                                                                                                                                                                  \
   SETTINGS_ITEM(YesNo,              AllowAdminMapUpload,      "Host",           "AllowAdminMapUpload",      Yes,                             ">>> Add AllowAdminMapUpload Help ")                                                                                                                                                                                             \
   SETTINGS_ITEM(YesNo,              AllowLevelgenUpload,      "Host",           "AllowLevelgenUpload",      Yes,                             ">>> Add AllowLevelgenUpload Help ")                                                                                                                                                                                             \
   SETTINGS_ITEM(YesNo,              VoteEnable,               "Host",           "VoteEnable",               No,                              ">>> Add VoteEnable Help ")                                                                                                                                                                                                      \
   SETTINGS_ITEM(U32,                VoteLength,               "Host",           "VoteLength",               12,                              "Time voting will last, in seconds. Zero will disable voting.")                                                                                                                                                                  \
   SETTINGS_ITEM(U32,                VoteLengthToChangeTeam,   "Host",           "VoteLengthToChangeTeam",   10,                              ">>> Add VoteLengthToChangeTeam Help ")                                                                                                                                                                                          \
   SETTINGS_ITEM(U32,                VoteRetryLength,          "Host",           "VoteRetryLength",          30,                              "When a vote fails, the vote caller is unable to vote until after this number of seconds.")                                                                                                                                      \
   SETTINGS_ITEM(S32,                VoteYesStrength,          "Host",           "VoteYesStrength",           3,                              "VoteYesStrength")                                                                                                                                                                                                               \
   SETTINGS_ITEM(S32,                VoteNoStrength,           "Host",           "VoteNoStrength",           -3,                              ">>> Add VoteNoStrength Help ")                                                                                                                                                                                                  \
   SETTINGS_ITEM(S32,                VoteNothingStrength,      "Host",           "VoteNothingStrength",      -1,                              ">>> Add VoteNothingStrength Help")                                                                                                                                                                                              \
   SETTINGS_ITEM(YesNo,              AllowTeamChanging,        "Host",           "AllowTeamChanging",        Yes,                             ">>> Add AllowTeamChanging Help ")                                                                                                                                                                                               \
   SETTINGS_ITEM(string,             DefaultRobotScript,       "Host",           "DefaultRobotScript",       "s_bot.bot",                     "If user adds a robot, this script is used if none is specified")                                                                                                                                                                \
   SETTINGS_ITEM(string,             GlobalLevelScript,        "Host",           "GlobalLevelScript",        "",                              "Specify a levelgen that will get run on every level")                                                                                                                                                                           \
   SETTINGS_ITEM(YesNo,              GameRecording,            "Host",           "GameRecording",            No,                              ">>> Add GameRecording Help ")                                                                                                                                                                                                   \
