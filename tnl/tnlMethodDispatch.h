...
{
   enum {
      VectorSizeBitSize = 8,     // CE: Was 8 --> Controls number of bits used to write the length of arrays to
   ...
   template <> inline void read<std::string>(TNL::BitStream &s, std::string *val)
   {
      char cstr[255];
      s.readString(cstr);
      std::string tmp = cstr;
   ...
   template <> inline void write(TNL::BitStream &s, std::string &val)
   {
      char *cstrLine;
...
struct FunctorDecl<void (T::*)(A,B,C,D,E,F,G,H,I,J,K,L,M)>: public Functor {
   ...
   void dispatch(void *t) { (((T *)t)->*ptr)(a, b, c, d, e, f, g, h, i, j, k, l, m); }
};
...
struct FunctorDecl<void (T::*)(A,B,C,D,E,F,G,H,I,J,K,L,M,N)>: public Functor {
   ...
   void dispatch(void *t) { (((T *)t)->*ptr)(a, b, c, d, e, f, g, h, i, j, k, l, m, n); }
};
...
struct FunctorDecl<void (T::*)(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O)>: public Functor {
   ...
   void dispatch(void *t) { (((T *)t)->*ptr)(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o); }
};
...
struct FunctorDecl<void (T::*)(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P)>: public Functor {
   ...
   void dispatch(void *t) { (((T *)t)->*ptr)(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p); }
};
...
struct FunctorDecl<void (T::*)(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q)>: public Functor {
   ...
   void dispatch(void *t) { (((T *)t)->*ptr)(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q); }
};
