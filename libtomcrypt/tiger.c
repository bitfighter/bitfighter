...
INLINE static void HashRound(ulong64 *a, ulong64 *b, ulong64 *c, 
ulong64 x, int mul)
{
    ulong64 tmp;
    tmp = (*c ^= x); 
...
{
   HashRound(a,b,c,x[0],mul); 
   HashRound(b,c,a,x[1],mul); 
   HashRound(c,a,b,x[2],mul); 
   HashRound(a,b,c,x[3],mul); 
   HashRound(b,c,a,x[4],mul); 
   HashRound(c,a,b,x[5],mul); 
   HashRound(a,b,c,x[6],mul); 
   HashRound(b,c,a,x[7],mul);          
}   
