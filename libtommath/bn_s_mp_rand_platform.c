...
#if defined(BN_S_READ_ARC4RANDOM_C)
mp_err s_read_arc4random(void *p, size_t n);
#endif
#if defined(BN_S_READ_WINCSP_C)
mp_err s_read_wincsp(void *p, size_t n);
#endif
#if defined(BN_S_READ_GETRANDOM_C)
mp_err s_read_getrandom(void *p, size_t n);
#endif
#if defined(BN_S_READ_URANDOM_C)
mp_err s_read_urandom(void *p, size_t n);
#endif
#if defined(BN_S_READ_LTM_RNG)
